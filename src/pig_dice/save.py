...
class Save:
    ...
    def save(self,player1,player2,played_game,filname="game_history.json"):
        ...
        - filename (str): The filename to save the data to. Default is "game_history.json".
    ...
    def load(self,filname="game_history.json"):
        ...
        Parameters:
        - filename (str): The filename to load the data from. Default is "game_history.json".
